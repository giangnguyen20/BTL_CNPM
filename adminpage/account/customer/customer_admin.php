...
if(isset($_GET['delete_id'])){
	...
	$sql='delete from khachhang where IDKH="'.$delete_id.'"';
	execute($sql);
}
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table class="table table-bordered table-hover" id="myTable">
					...
					$sql="select * from khachhang limit ".$firstIndex.", ".$limit." ";
					$categoryList=executeResult($sql);

					$sql2='select count(IDKH) as total from khachhang';
					...
					<tr>
                        ...
                        <td>'.$item['IDuser'].'</td>
						<td>
							<a href="customer_add.php?IDKH='.$item['IDKH'].'"><button class="btn btn-warning">Sửa</button></a>
						</td>
						<td>
							<a href="?delete_id='.$item['IDKH'].'"><button class="btn btn-danger">Xoá</button></a>
						</td>
					</tr>';
					}
					?>
