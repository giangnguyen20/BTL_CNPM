		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table class="table table-bordered table-hover" id="myTable">
					...
					$sql="select * from loaisp limit ".$firstIndex.", ".$limit." ";
					$categoryList=executeResult($sql);

					$sql2='select count(IDLoaiSP) as total from loaisp';
					...
					<tr>
						...
						<td>'.$item['tenloai'].'</td>
						<td>
							<a href="add.php?IDLoaiSP='.$item['IDLoaiSP'].'"><button class="btn btn-warning">Sửa</button></a>
						</td>
						<td>
