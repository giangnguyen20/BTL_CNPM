...
if(isset($_GET['delete_id'])){
	...
	$sql='delete from nhasx where IDNSX="'.$delete_id.'"';
	execute($sql);
}
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Quản Lý NSX</h2>
			</div>
			<div class="panel-body">

				<a href="addmanufacturer.php">
				<button class="btn btn-success" style="margin: bottom 15px;">Thêm NSX</button>
				</a>
				<br></br>
				...
				<table class="table table-bordered table-hover" id="myTable">
					...
					$sql="select * from nhasx limit ".$firstIndex.", ".$limit." ";
					$categoryList=executeResult($sql);

					$sql2='select count(IDNSX) as total from nhasx';
					...
					<tr>
                        ...
                        <td>'.$item['SDT'].'</td>
						<td>
							<a href="addmanufacturer.php?IDNSX='.$item['IDNSX'].'"><button class="btn btn-warning">Sửa</button></a>
						</td>
						<td>
							<a href="?delete_id='.$item['IDNSX'].'"><button class="btn btn-danger">Xoá</button></a>
						</td>
					</tr>';
					}
					?>
